...
class TokensUnitTest {
  ...
  fun testAuthToken_parsing() {
    ...
    assertEquals("2026-08-20T21:00:00.000Z", authToken.expireTime)
    assertEquals("2026-08-20T20:31:00.000Z", authToken.newSessionExpireTime)
  }
}
