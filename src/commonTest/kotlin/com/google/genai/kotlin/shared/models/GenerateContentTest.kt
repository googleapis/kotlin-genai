...
class GenerateContentTest : SharedTestBase() {
  ...
  /** Canonical models/generate_content: test_generate_content. */
  @Test
  fun testGenerateContent() = runTest {
    listOf(false, true).forEach { enterprise ->
      ...
      val testName = "shared.models.GenerateContentTest.testGenerateContent.$suffix"
      ...
      runLive {
        ...
        assertTrue(!response.text.isNullOrBlank(), "Expected non-empty generated text")
      }
    }
  }
