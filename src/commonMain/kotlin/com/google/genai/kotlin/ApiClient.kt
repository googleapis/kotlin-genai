...
// Default HTTP retry configuration, matching the Python SDK.
// LINT.IfChange
 ...
 * single attempt. Retryability is decided on the response status, since this client does not set
 * Ktor's `expectSuccess`.
 */
